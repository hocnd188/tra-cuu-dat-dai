...
// Cấp/thu hồi quyền Hỏi đáp (can_qa) và Dùng AI (can_ai) cho một user thường.
// Dùng PATCH /api/users (không phải route động) để tránh mọi vấn đề nhận diện route [id].js.
